...
window.onload = function strike(){
  ...
  function str1Stop (){
  	...
  	st1.classList.remove('strike-running');
  	st1.classList.remove('strike');
  	console.log('stop');
  	...
  	st1.classList.remove('strike-paused');
  	st1.classList.add('strike');
  	st1.classList.add('strike-running');
